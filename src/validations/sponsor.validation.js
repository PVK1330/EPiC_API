...
export const createSponsorSchema = z.object({
  body: z.object({
    ...
    authorisingPhone: z.string().trim().max(30).optional().nullable(),
...
export const updateSponsorSchema = z.object({
  ...
  body: z.object({
    ...
    keyContactPhone: z.string().trim().max(30).optional().nullable(),
    ...
    hrPhone: z.string().trim().max(30).optional().nullable(),
