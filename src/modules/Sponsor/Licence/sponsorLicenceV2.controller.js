...
export const listMyApplications = async (req, res) => {
  try {
    ...
    const apps = await req.tenantDb.LicenceApplication.findAll({
      ...
      attributes: ["id", "applicationVersion", "status", "type", "currentStep", "companyName", "licenceType", "submittedAt", "feeTotal", "feeCurrency", "createdAt", "updatedAt", "rejectionCooldownUntil"],
    });
