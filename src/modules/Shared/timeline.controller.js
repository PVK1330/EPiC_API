...
export const createTimelineEntry = async (req, res) => {
  try {
    ...
    const createdEntry = await req.tenantDb.CaseTimeline.findByPk(timelineEntry.id, {
      include: [
        {
          model: req.tenantDb.User,
          as: 'performer',
...
export const updateTimelineEntry = async (req, res) => {
  try {
    ...
    const timelineEntry = await req.tenantDb.CaseTimeline.findByPk(id);
    ...
    const updatedEntry = await req.tenantDb.CaseTimeline.findByPk(id, {
      include: [
        {
          model: req.tenantDb.User,
          as: 'performer',
